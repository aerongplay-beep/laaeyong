    ...
    <footer className="w-full bg-[#3E4A20] text-white/85">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
          ...
          <div className="hidden md:flex gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> hello@playreset.kr</li>
        ...
        <div className="mt-8 pt-6 border-t border-white/15 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/60">© 2026 Play Reset. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <span className="text-xs text-white/50 hidden sm:inline">문의: 예약 폼 · hello@playreset.kr</span>
